...
namespace PairProgrammingGame
{
    class Repository
    {
        ...
        public void Shuffle()
        {
            ...
            deck._deck.Add(0, new Card("Ace",11, Suit.Spades, 0));
            ...
            deck._deck.Add(13, new Card("Ace",11,Suit.Clubs,13));
            ...
            deck._deck.Add(26, new Card("Ace",11,Suit.Hearts,26));
            ...
            deck._deck.Add(39, new Card("Ace",11,Suit.Diamonds,39));
        ...
        public void Deal()
        {
            ...
            for (int i = 0; i < 2; ++i)
            {
                ...
                Console.WriteLine($"You were dealt a {newCard.Number} of {newCard.Suit}");
                --currentDeckSize;
            }
       ...
       public int PlayerTotal()
        ...
        // Run the bust method is there an ace? if(ace) do two calulations

        // Method for player actions
        // Player needs to be able to hit until >=21
        // Player nees to be able to 'stand' lock in cards
       ...
       public void Dealer()
        ...
        public void WinnerOutput()
        {
            ...
            else if (playerTotal > total) { Console.WriteLine("Player Wins"); }
